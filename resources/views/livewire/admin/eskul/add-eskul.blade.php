                    ...
                    <div class=" card">
                        <form wire:submit.prevent="add" class="card" enctype="multipart/form-data">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Form Ekstrakulikuler</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input wire:model="foto" id="fileInput" type="file" class="form-control"
                            ...
                            <div class="card-footer text-end">
                                <div class="d-flex">
                                    <button id="submitButton" type="submit" style="min-width: 100px"
